...
public class BinarySearchTree {
	...
	/**
	 * * search: 在二叉查找树中查询给定关键字 * @param key 给定关键字 * @return 匹配给定关键字的树结点
	 */
	...
	/**
	 * * maxElemNode: 获取二叉查找树中的最大关键字结点 * @return 二叉查找树的最大关键字结点 若树为空 ， 则抛出异常
	 */
	...
	/**
	 * successor: 获取给定结点在中序遍历顺序下的后继结点 给定树中的结点
	 * 
	...
	/**
	 * * precessor: 获取给定结点在中序遍历顺序下的前趋结点 * @param node 给定树中的结点 * @return
	 * 若该结点存在中序遍历顺序下的前趋结点 ， 则返回其前趋结点 ； 否则返回 null * @throws Exception
	 */
	...
	/**
	 * * delete: 从二叉查找树中删除给定的结点. 前置条件： 给定结点在二叉查找树中已经存在
	 * 
	 */
	...
	/**
	 * * inOrderTraverseList: 获得二叉查找树的中序遍历结点列表 * @return 二叉查找树的中序遍历结点列表
	 */
	...
	/**
	 * * inOrderTraverse: 对给定二叉查找树进行中序遍历 * @param root 给定二叉查找树的根结点
	 */
	...
	/**
	 * * toStringOfOrderList: 获取二叉查找树中关键字的有序列表 * @return 二叉查找树中关键字的有序列表
	 */
